...
- Amazon Web Services. (n.d.). What is SQL?. Retrieved from https://aws.amazon.com/what-is/sql/
- Microsoft. (n.d.). Power BI Documentation. Retrieved from https://learn.microsoft.com/en-us/power-bi/
- Microsoft. (n.d.). SQL Server Documentation. Retrieved from https://learn.microsoft.com/en-us/sql/sql-server/?view=sql-server-ver16
- The Knowledge Academy. (n.d.). Advantages of SQL. Retrieved from https://www.theknowledgeacademy.com/blog/advantages-of-sql/
